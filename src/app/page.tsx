            ...
            <div>
              ...
              >
                <span style={{ display: 'inline-block', width: '900px' }}>
                  UBC UX Hub empowers students through hands-on learning, creative collaboration, and access to
                  the latest in user experience and emerging technology.
                </span>
              </p>
        ...
        <div className="mt-[100px] px-[300px] pb-[100px]">
          ...
          <div className="flex gap-[40px] justify-center">
            ...
            >
              ...
              >
                We empower UBC students to explore and excel in UX design through hands-on learning, industry connections, and collaborative projects. Our goal is to bridge the gap between academic learning and real-world UX practices.
              </p>
            </div>
            <div 
              className="flex-1 p-[40px] rounded-[20px]"
            ...
            >
              ...
              >
                Join a diverse community of aspiring designers, researchers, and creative problem-solvers. We welcome students from all backgrounds who share a passion for creating meaningful user experiences.
              </p>
            </div>
          </div>
        </div>
