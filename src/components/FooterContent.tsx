...
const FooterContent: React.FC<FooterContentProps> = ({
  ...
  return (
    <div className="flex items-center justify-center w-screen py-20 lg:py-20 md:py-16 sm:py-12 max-h-[500px] max-w-[1000px] mx-auto rounded-[20px] lg:mt-[100px] mt-20 bg-gradient-to-r from-[#052462] via-[#CA97CE] to-[#F09485]">
      <div className="max-w-6xl mx-auto px-8 text-center  lg:w-[552px]  md:w-[500px]  sm:w-full  flex flex-col justify-center items-center gap-5">
