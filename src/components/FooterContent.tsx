...
const FooterContent: React.FC<FooterContentProps> = ({
  ...
  return (
    <div className="flex items-center justify-center py-20 lg:py-20 md:py-16 sm:py-12 max-h-[500px] mx-auto rounded-[20px] lg:mt-[100px] bg-gradient-to-r from-[#052462] via-[#CA97CE] to-[#F09485] px-10">
