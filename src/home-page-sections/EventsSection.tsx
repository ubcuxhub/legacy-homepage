...
const EventsSection: React.FC = () => {
  ...
  return (
    <div id="events" className="px-[5%] md:px-[10%] xl:px-[20%]">
      <div className="mb-8">
      ...
      <div className="text-center flex justify-center">
        <Button
          ...
          className="mt-20 group border-[2px] border-[#383838]"
          icon={
            <svg
              width="20"
              height="20"
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="shrink-0 transition-all duration-300 ease-in-out group-hover:rotate-45 group-hover:text-[#383838]"
            >
              <path
