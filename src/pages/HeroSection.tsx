...
export default function HeroSection({ children }: HeroSectionProps) {
  return (
    <section className="w-[90%] max-w-[1100px] h-[calc(100vh-140px)] flex-shrink-0 rounded-[20px] border border-[#C1C7CD] bg-[#f5f5f5] relative overflow-visible flex flex-col items-center">
      ...
      {/* Content area */}
      <div className="flex w-full flex-col items-start justify-center gap-10 sm:gap-10 md:gap-[60px] lg:gap-[80px] flex-1 px-6 pt-10 pb-10 sm:px-10 sm:pt-10 sm:pb-10 md:px-20 md:pt-[60px] md:pb-[60px] lg:px-32 lg:pt-20 lg:pb-32">
        {children}
      </div>
    </section>
  );
